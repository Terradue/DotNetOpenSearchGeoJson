...
EXTRA_DIST =  rules.make configure Makefile.include externals/DotNetGeoJson/packages/ServiceStack.Text.3.9.71/lib/net35/ServiceStack.Text.dll packages/ServiceStack.Text.3.9.71/lib/net35/ServiceStack.Text.dll
...
ifeq ($(CONFIG),DEBUG)
 SUBDIRS =  externals/DotNetGeoJson/Terradue.GeoJson externals/DotNetOpenSearch/Terradue.OpenSearch Terradue.OpenSearch.GeoJson
endif
ifeq ($(CONFIG),RELEASE)
 SUBDIRS =  externals/DotNetGeoJson/Terradue.GeoJson externals/DotNetOpenSearch/Terradue.OpenSearch Terradue.OpenSearch.GeoJson
endif
